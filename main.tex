...
\begin{table}[H]
    ...
    \begin{tabular}{l c c c c c c}
        ...
        \midrule
        & \multicolumn{4}{c}{Estimated Division Lengths $[\tilde{l}]=\unit{\micro\metre}$}\\
        Morse                               & 2.1080 & 2.2957 & 2.0803 & 1.9870\\
        \bottomrule
    \end{tabular}
    \caption{
...
Starting from the notation for the vertices $\nu_{i,j,k,l}$ of shape $(N_c,N_v,d,N_t)$ introduced in
section~\ref{subsec:direct-metric}, we focus on one particular cell $c_i$ at a given time point
$t_l$ and denote the resulting quantity with $\nu_{j,k}$, therefore dropping the indices $i,l$.
