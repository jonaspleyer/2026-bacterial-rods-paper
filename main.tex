...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.5\textwidth]
        {figures/docs/mechanics.pdf}
        \node at (0, 1)[anchor=north west]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {figures/docs/interaction.pdf}
        \node at (0, 1)[anchor=north west]{\textbf{B}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.5\textwidth]
        {figures/docs/mie-potential-shapes.pdf}
        \node at (0, 1)[anchor=north west]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {figures/docs/morse-potential-shapes.pdf}
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.32\textwidth]
        {figures/docs/imaging-mesh.pdf}
        \node at (0.025, 0.975)[anchor=north west]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.32\textwidth]
        {figures/docs/11571737453049821261/raw_pv/000000400.png}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{B}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.32\textwidth]
        {figures/docs/11571737453049821261/masks/000000400.png}
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.36\textwidth]
        {figures/docs/fitting-methods/algorithm/image001042.png}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.36\textwidth]
        {figures/docs/fitting-methods/algorithm/mask-zoom.pdf}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{B}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.255\textwidth]
        {figures/docs/fitting-methods/algorithm/interpolate-positions.pdf}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{C}};
    \end{tikzonimage}\\
    \vspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {figures/docs/fitting-methods/extract_positions-001800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white]{\textbf{D}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {figures/docs/fitting-methods/extract_positions-003800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white]{\textbf{E}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {figures/docs/fitting-methods/extract_positions-005800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white]{\textbf{F}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {figures/docs/fitting-methods/extract_positions-007800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white]{\textbf{G}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {figures/docs/fitting-methods/extract_positions-009800.pdf}
        \node at (0.03, 0.99)[anchor=north west, white]{\textbf{H}};
    \end{tikzonimage}%
    \hspace{0.004\textwidth}%
    \begin{tikzonimage}[width=0.1625\textwidth]
        {figures/docs/fitting-methods/extract_positions-009800-cropped.pdf}%
        \node at (0, 1)[anchor=north west, white]{\textbf{I}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.33\textwidth]
        {figures/docs/fitting-methods/displacement-calculations.pdf}%
        \node at (0, 1)[anchor=north west, black]{\textbf{J}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.33\textwidth]
        {figures/docs/fitting-methods/displacement-distribution.pdf}
        \node at (0, 1)[anchor=north west, black]{\textbf{K}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.33\textwidth]
        {figures/docs/fitting-methods/displacement-fit-over-time.pdf}
...
relationship.
Similar to the preceding section we assume $I=I(\theta)$ to be the model output which therefore
informs $L(\theta,I,\tilde{I})$.
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.24\textwidth]
        {figures/docs/fitting-methods/progressions-1.pdf}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{A}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.24\textwidth]
        {figures/docs/fitting-methods/progressions-2.pdf}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{B}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.24\textwidth]
        {figures/docs/fitting-methods/progressions-3.pdf}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{C}};
    \end{tikzonimage}%
    \hspace{0.01\textwidth}%
    \begin{tikzonimage}[width=0.24\textwidth]
        {figures/docs/fitting-methods/progressions-4.pdf}
        \node at (0.025, 0.975)[anchor=north west, white]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{minipage}{\textwidth}
        \begin{tikzonimage}[width=0.48\textwidth]
            {figures/docs/fitting-methods/extract_positionsdivision-comparison.pdf}
            \node at (0, 1)[anchor=north west]{\textbf{E}};
        \end{tikzonimage}%
        \hspace{0.01\textwidth}%
        \begin{tikzonimage}[width=0.48\textwidth]
            {figures/docs/fitting-methods/penalty-time-flow.pdf}
...
extraction algorithm (solid curves). To quantify this heterogeneity, we fit the individual curves
with an exponential:
\begin{equation}
    l(t) = l_0 \exp(\mu t).
...
Furthermore, the spring tension $\gamma$ serves as an auxiliary parameter which is also assumed to
be constant.
{\bf [siehe meinen Kommentar weiter oben.]}
...
{\bf [du musst auf Fig. 8 verweisen, bevor du Fig. 9 erwähnst]}
Figure~\ref{fig:parameter-estimates-single-step} shows the profile-likelihoods for each optimized
parameter. We compare four distinct models, covering both Morse and Mie-type interactions with a
fixed damping
constant $\lambda=\SI{1}{\per\minute}$.
Figure~\ref{fig:parameter-estimates-single-step} (A) displays the profile-likelihood for the damping
constant $\lambda$ and exhibits a wide range of permissible parameter values which motivates the
approach to treat this parameter as a constant thus reducing our overall model.
{\bf [so kannst du nicht argumentieren. Alle Parameter sind am Ende konstant.]}
The parameters which characterize the Morse-type interaction are the potential stiffness strength
and radius, Figure~\ref{fig:parameter-estimates-single-step} (B, E, F). While the potential
stiffness (B) and radius (F) can be accurately estimated from the given data, the potential strength
(E) is subject to a practical unidentifiability~\cite{Raue2009} which is resolved by fixing the
damping constant to $\lambda=\SI{1}{\per\minute}$.
...
(A,C,D,E) show, neither the full Mie-type interaction nor a reduced model with
$\lambda=\SI{1}{\per\minute}$ allow for the estimation of the exponents $n,m$.
{\bf [$\lambda$ hat nichts mit dem Potential zu tun. Der Gegensatz full ... reduced ist so nicht zutreffend]}
It is necessary to enhance the data set with
{\bf [welchen Datentypus wird hier benötigt?]} to remove this practical non-identifiability.
Notably, the two interaction types result in different predictions for the radii
(Figure~\ref{fig:parameter-estimates-single-step} (F)).
However, the $68\,\%$ confidence intervals overlap.
...
\begin{figure}[H]
    ...
    \caption{
        ...
        {\bf [das versteht man so nicht. Entweder weglassen oder richtig erklären]}
    }
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-damping.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-potential-stiffness.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{B}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-exponent-n.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-exponent-m.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-strength.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{E}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-radius.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-growth-rate-0.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{G}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-growth-rate-1.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{H}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-growth-rate-2.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{I}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-growth-rate-3.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{J}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-growth-rate-4.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{K}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_fit/profiles/profile-growth-rate-5.pdf}%
    ...
    \caption{
        ...
        {\bf [die Beschriftung der y-Achse ist nicht richtig. Es muss PL($\mu$) usw. heissen]}
    }
...
events which meant that we had to omit a subset of snapshots, leaving us with incomplete temporal
data.
{\bf [das ist unverständlich. Konnte man das nicht manuell korrigieren? Und warum musste eine Untermenge an Snapshots entfernt werden?]}
This problem is common for existing segmentation algorithms and may also be encountered in future
studies.
We therefore explicitly include this gap to assess the fidelity of our approach under these
practical challenges.

In order to compare the experimentally obtained data with simulation results, there are four main
steps which are executed within any single optimization iteration.
{\bf [du hast doch bis jetzt mehrmals über den Vergleich von Simulation und Daten geredet. Warum erwähnst du das erst hier?]}
...
This requires us to map the cell-lineage forest (collection of trees) of the numerical result to the
experimental data. Finally, we use the previously established lineage-aware image-based metric for
the comparison.
...
We used the value $p=0.5$ for the parent penalty, which aims to provide a smooth transition between
not accounting for them and assigning full weighting to this difference.
{\bf [der Satz ist unvollständig]}
...
\begin{figure}[H]
    \centering
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-potential-stiffness.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{A}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-strength.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{B}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-radius.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-0.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{D}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-1.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{E}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-2.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{F}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-3.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{G}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-4.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{H}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-5.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{I}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-division-length-0.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{J}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-division-length-1.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{K}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-division-length-2.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{L}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-division-length-3.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{M}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-0-0.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{N}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-0-1.pdf}%
        \node at (0, 1.1)[anchor=north west, black]{\textbf{O}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.25\textwidth]
        {figures/crm_divide/profiles-pretty/pdf/profile-growth-rate-1-0.pdf}%
    ...
    \caption{
        ...
        {\bf [es bleibt unklar, warum hier keine PL. Die Bilder sehen schlecht aus.]}
    }
...
Furthermore, both methods {\bf [welche Methoden?]} involve additional steps when determining the
...
These distinct choices {\bf [welche distinct choices?]} may influence the obtained values at hand.

Table~\ref{tab:comparison-growth-rates} shows the obtained values for the growth rates via the
different techniques.
It also contains the total division lengths $\tilde{l}=(n_\text{vertices}-1)l$ which are obtained by
...
extracted position or by counting the number of pixels associated with each cell over the course of
the given time interval.
In both cases, the same exponential model as presented in equation~\ref{eq:exponential-growth-model}
is fitted to the data.
We can already see that this choice greatly influences the obtained results, leading to significant
...
\begin{table}[H]
    ...
    \begin{tabular}{l c c c c c c}
        ...
        Morse $\lambda=\SI{1}{\per\minute}$ & 0.0060 & 0.0070 & 0.0113 & 0.0078 & 0.0191 & 0.0093\\

        \multicolumn{7}{l}{\textbf{Lineage-Aware Image-Space Metric}}\\
        \midrule
        Morse                               & 0.0073 & 0.0060 & 0.0092 & 0.0126 & 0.0091 & 0.0094\\
        ...
        \bottomrule
    \end{tabular}
    \caption{{\bf [die Namen Position und Pixel Fit benutzt du hier zum ersten Mal]}
        ...
        {\bf [Was bedeuten die verschiedenen Division Length?]}
    }
...
{\bf [es bleibt unklar, welche Effekt du genau meinst.]}.
...
{\bf [du musst deine Notation erklären. Was sind $\nu_{i,j}$? Kann es sein, dass die Nenner nicht korrekt sind?]}
...
\begin{figure}[H]
    ...
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {figures/docs/fitting-methods/displacement-fit-over-time-covariance.pdf}
        \node at (0, 1)[anchor=north west, black]{\textbf{B}};
    \end{tikzonimage}\\
    \begin{tikzonimage}[width=0.5\textwidth]
        {figures/docs/fitting-methods/displacement-distr-x.pdf}
        \node at (0, 1)[anchor=north west, black]{\textbf{C}};
    \end{tikzonimage}%
    \begin{tikzonimage}[width=0.5\textwidth]
        {figures/docs/fitting-methods/displacement-distr-y.pdf}
        \node at (0, 1)[anchor=north west, black]{\textbf{D}};
    \end{tikzonimage}
    \caption{
...
{\bf [kann es sein, dass du die Zeitinformation, die in den Movies enthalten ist, in deinem Parameterfit nicht genutzt hast?]}
...
information and contextual clues, such as size of the bacteria themselves.
{\bf [wird die Grösse der Bakterien angegeben? Oder entnimmst du das der Literatur?]}
...
This can be done by rescaling all lengths, which will produce the same results with respect to the
profile likelihood.
However, values of the raw cost function will change since this involves a comparison of position
in the respective space (i.e. pixel or position) and is not normalized by the corresponding
displacement uncertainty.
{\bf [hierzu sollten wir nochmals reden]}
...
Figure~\ref{fig:supplement-cost-evolution-time} shows the missing profiles of growth rates of the
...
rate. {\bf [es ist unüblich die Zählung nicht bei 1 oder A anfangen zulassen.]}
...
{\bf [sind deine Annahmen unrealistisch?]}
...
trend, indicating that the model prediction using the estimated parameters yields a good
...
\begin{figure}[H]
    ...
    \caption{
        ...
        The fully optimized system does not contain any configurations in which a parent penalty $p$
        is utilized.
        {\bf [dieser Plot wirkt komisch mit der Legende]}
    }
