...
such comparisons. Using maximum-likelihood and profile-likelihood techniques we estimate the model
parameters, assess how reliably each parameter is determined and reduce the model where the data do
not constrain it. We show that individual differences between cells, such as their growth rates, can
be recovered directly from routine time-lapse microscopy. The methods are released as an open,
modular software package and can be reused for a wide range of models of rod-shaped organisms.
