...
\texttt{profile-likelihood}.
However, \texttt{profile-likelihoods} shown in Figure~\ref{fig:amir-bending-simulation} (E-I) are
...
Combining these advances, we applied profile-likelihood-based parameter estimation to case studies
of increasing complexity and showed that the involved parameters can be identified, that
...
employ well-known methods such as profile-likelihood and sensitivity analysis and reuse, extend and
combine existing building blocks to incorporate additional biological properties.
