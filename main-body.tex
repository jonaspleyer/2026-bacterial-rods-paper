...
All growth rates for the daughter cells (M-T) show similar behavior to the
...
In particular, it exhibits no plateaus due to missing data points.
...
{\bf [Hier stimmt etwas mit der Zählung nicht. Die Nummerierung der Zellen wird nirgends eingeführt oder erklärt. Auch scheint es mit das Konsistenzprobleme zu geben. Welche Zelle teilt sich, welche nicht? Dann verwendest du auch M-T. Bezieht sich das auf die Abbildung oder auf die Zellen?]}
\begin{figure}[H]
    \centering
